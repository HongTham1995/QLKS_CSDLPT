            ...
            if (textBox4.Text.Trim().Length == 0)
            {
                ...
                if (ans == MessageBoxDialog.YES_OPTION)
                {
                        ...
                        !lbErrorTenKH.Visible)
                    {
                        ...
                        {
                            string count = ctt.GetCountAll(sever,DateTime.Now.ToString("yyyy-MM-dd")).ToString("D5");
                            ...
                            for (int i = 0; i < dt.Rows.Count; i++)
                            {
                                if (dt.Rows[i][3].ToString().ToUpper().Equals("THEO NGÀY"))
                                    cttp.InsertCTTP(sever,true, txtMaCTT.Text.Trim(), dt.Rows[i][0].ToString().Trim(), DateTime.Parse(dt.Rows[i][4].ToString().Trim()).ToString("yyyy-MM-dd HH:mm:ss"), DateTime.Parse(dt.Rows[i][5].ToString().Trim()).ToString("yyyy-MM-dd HH:mm:ss"), "0", dt.Rows[i][7].ToString());
                                else if (dt.Rows[i][3].ToString().ToUpper().Equals("THEO GIỜ"))
                                    cttp.InsertCTTP(sever,true, txtMaCTT.Text.Trim(), dt.Rows[i][0].ToString().Trim(), DateTime.Parse(dt.Rows[i][4].ToString().Trim()).ToString("yyyy-MM-dd HH:mm:ss"), DateTime.Parse(dt.Rows[i][5].ToString().Trim()).ToString("yyyy-MM-dd HH:mm:ss"), "1", dt.Rows[i][7].ToString());
                                else
                                    cttp.InsertCTTP(sever,false, txtMaCTT.Text.Trim(), dt.Rows[i][0].ToString().Trim(), DateTime.Parse(dt.Rows[i][4].ToString().Trim()).ToString("yyyy-MM-dd HH:mm:ss"), DateTime.Parse(dt.Rows[i][4].ToString().Trim()).ToString("yyyy-MM-dd HH:mm:ss"), "2", dt.Rows[i][7].ToString());
                            }
            ...
            else
            {
                    ...
                    !lbErrorTenKH.Visible)
                {
                    ...
                    else
                    {
                        ...
                        ctt.InsertCTT(sever, txtMaCTT.Text.Trim(), txtMaKH.Text.Trim(), Program.nhanVien.MaNV, DateTime.ParseExact(txtNgayLap.Text, "dd/MM/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture).ToString("yyyy-MM-dd HH:mm:ss"), textBox4.Text);
                        for (int i = 0; i < dt.Rows.Count; i++)
                        {
                            if (dt.Rows[i][3].ToString().ToUpper().Equals("THEO NGÀY"))
                                cttp.InsertCTTP(sever,true, txtMaCTT.Text.Trim(), dt.Rows[i][0].ToString().Trim(), DateTime.Parse(dt.Rows[i][4].ToString().Trim()).ToString("yyyy-MM-dd HH:mm:ss"), DateTime.Parse(dt.Rows[i][5].ToString().Trim()).ToString("yyyy-MM-dd HH:mm:ss"), "0", dt.Rows[i][7].ToString());
