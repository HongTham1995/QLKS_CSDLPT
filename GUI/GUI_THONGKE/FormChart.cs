...
namespace GUI.GUI_THONGKE
{
    public partial class FormChart : Form
    {
        ...
        void BieuDoPhongLoad(string tungay, string denngay)
        {
            ...
            int total = hd.TongLoaiPhong(sever,tungay, denngay);
            int totalVip = hd.TongLoaiPhongVip(sever, tungay, denngay);
            int totalThuong = hd.TongLoaiPhongThuong(sever, tungay, denngay);
        ...
        void BieuDoLoaiPhongLoad(string tungay, string denngay)
        {
            ...
            int total = hd.TongLoaiPhong(sever, tungay, denngay);
            int totalDon = hd.TongLoaiPhongDon(sever, tungay, denngay);
            int totalDoi = hd.TongLoaiPhongDoi(sever, tungay, denngay);
            int totalGiaDinh = hd.TongLoaiPhongGiaDinh(sever, tungay, denngay);
        ...
        void BieuDoThongKeThangLoad(int thang, int nam)
        {
            ...
            {
                var roomRevenue = hd.TongTienPhongTrongMotNgay(sever, i.ToString(), thang.ToString(), nam.ToString());
                var serviceRevenue = hd.TongTienDichVuTrongMotNgay(sever, i.ToString(), thang.ToString(), nam.ToString());
        ...
        void BieuDoThongKeNamLoad(int nam)
        {
            ...
            for (int i = 1; i <= 12; i++)
            {
                var roomRevenue = hd.TongTienPhongTrongMotThang(sever, i.ToString(), nam.ToString());
                var serviceRevenue = hd.TongTienDichVuTrongMotThang(sever, i.ToString(), nam.ToString());
