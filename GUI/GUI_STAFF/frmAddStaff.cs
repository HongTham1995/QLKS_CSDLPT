...
namespace GUI.GUI_STAFF
{
    public partial class frmAddStaff : Form
    {
        ...
        public frmAddStaff()
        {
            ...
            NVCount = nhanVienBUS.getNhanVienCount(sever);
            if (this.isAdd)
                setMaNV();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (xacNhan)
            {
                ...
                NhanVienDTO nv = new NhanVienDTO(manv, tennv, gioitinh, songayphep, chucvu, ngaysinh, ngayvaolam, email, luong1ngay,0, maCN);
                if (this.isAdd)
                {
