    ...
    public partial class frmAddRoom : Form
    {
        ...
        private void btnAddRoom_Click(object sender, EventArgs e)
        {
            ...
            if (!check)
            {
                ...
                {
                    int count = phong.getCountPhong(sever) + 1;
                    ...
                    phong.ThemPhong(sever,maCN+txtMaP.Text.Trim(), txtTenP.Text.Trim(), loaiP, txtGiaP.Text.Trim(), chiTietLoaiP, 0 + "", 0 + "", maCN);
        ...
        private void btnDeleteRoom_Click(object sender, EventArgs e)
        {
            ...
            {
                phong.XoaPhong(sever,txtMaP.Text.Trim());
        ...
        private void btnUpdateRoom_Click(object sender, EventArgs e)
        {
            ...
            if (!check)
            {
                ...
                if (ans == MessageBoxDialog.YES_OPTION)
                {
                    ...
                    phong.SuaPhong(sever,txtMaP.Text.Trim(), txtTenP.Text.Trim(), loaiP, txtGiaP.Text.Trim(), chiTietLoaiP, cbHT.SelectedIndex.ToString());
                    this.DialogResult = DialogResult.OK;
